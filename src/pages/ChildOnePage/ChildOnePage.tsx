        ...
        <Row>
          ...
          <Col xl={9}>
            <div className="content">
              ...
              <Paragraph>
                Stimulab skal stimulere til offentlig innovasjon fra brukernes
                perspektiv. Vi tilbyr tverrfaglig veiledning og midler til
                innovative utviklingsprosjekter. Målet er helthetlige tjenester
                for brukerne og en mer effektiv forvaltning.
              </Paragraph>
